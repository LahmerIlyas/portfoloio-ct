  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      [
        ...
        'VIEW',
        'daily_calories',
        'SELECT "entry"."user_id" AS "user_id", TO_CHAR("entry"."taken_at", \'yyyy-mm-dd\') AS "date", sum("entry"."calories_count") AS "calories_count" FROM "food_entry" "entry" GROUP BY TO_CHAR("entry"."taken_at", \'yyyy-mm-dd\'), "entry"."user_id" ORDER BY TO_CHAR("entry"."taken_at", \'yyyy-mm-dd\') DESC',
      ],
    );
    await queryRunner.query(`
    ...
    await queryRunner.query(
      ...
      [
        ...
        'VIEW',
        'monthly_spending',
        'SELECT "entry"."user_id" AS "user_id", to_char(taken_at,\'YYYY-MM\') AS "month", sum("entry"."price") AS "spending" FROM "food_entry" "entry" GROUP BY to_char(taken_at,\'YYYY-MM\'), "entry"."user_id" ORDER BY to_char(taken_at,\'YYYY-MM\') DESC',
      ],
    );
  }
